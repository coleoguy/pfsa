...
# lets make complex sex chromosome systems as XY
# dat$SCS[dat$SCS %in% c("XXY", "XYY")] <- "XY"
...
tiplabels(col = c("red", "blue", "green", "black")[as.factor(inputs$dat$scs)], pch = 16, offset = 1, cex = .5)
